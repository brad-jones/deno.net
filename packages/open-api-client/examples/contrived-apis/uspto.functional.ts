 ...
 */
export const listSearchableFields = (config: OpenAPIClientConfig, request: {
  path: {
    /** Name of the dataset. */
    dataset: string;
 ...
 */
export const performSearch = (config: OpenAPIClientConfig, request: {
  path: {
    /** Version of the dataset. */
    version: string;
...
export function createClient(config: OpenAPIClientConfig) {
  return createCustomClient(config, { listDataSets, listSearchableFields, performSearch });
}

 ...
 * Lists products.
 */
export const productsList = (config: OpenAPIClientConfig, request?: {
  query?: {
 ...
 * Creates a product.
 */
export const productsCreate = (config: OpenAPIClientConfig, request: {
  headers?: {
 ...
 */
export const productsGet = (config: OpenAPIClientConfig, request: {
  path: {
    /** The product ID. */
    product_id: string;
  };
 ...
 */
export const productsPatch = (config: OpenAPIClientConfig, request: {
  path: {
    /** The product ID. */
    product_id: string;
  };
...
export function createClient(config: OpenAPIClientConfig) {
  return createCustomClient(config, { productsList, productsCreate, productsGet, productsPatch });
}

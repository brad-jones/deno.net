...
export class ApiClient {
        ...
        this.config,
        {
          ...
          requestSchema: z.object({
            headers: z.object({
              ...
              Prefer: z.string().regex(new RegExp("^[a-zA-Z=,-]*$")).min(1).max(25).default("return=minimal")
                .optional(),
  ...
  readonly "/v2/checkout/orders/{id}" = {
    /**
     * Show order details
     *
  ...
  readonly "/v2/checkout/orders/{id}/authorize" = {
    /**
  ...
  readonly "/v2/checkout/orders/{id}/capture" = {
    /**
  ...
  readonly "/v2/checkout/orders/{id}/confirm-payment-source" = {
    /**
     * Confirm the Order
     *
  ...
  readonly "/v2/checkout/orders/{id}/track" = {
    /**
  ...
  readonly "/v2/checkout/orders/{id}/trackers/{tracker_id}" = {
    /**
  ...
  readonly "/v2/checkout/orders/order-update-callback" = {
    /**

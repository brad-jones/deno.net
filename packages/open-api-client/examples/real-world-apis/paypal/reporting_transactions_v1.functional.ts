 ...
 */
export const searchGet = (config: OpenAPIClientConfig, request: {
  query: {
 ...
 */
export const balancesGet = (config: OpenAPIClientConfig, request?: {
  query?: {
...
export function createClient(config: OpenAPIClientConfig) {
  return createCustomClient(config, { searchGet, balancesGet });
}

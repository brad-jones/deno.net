 ...
 */
export const trackersBatchGet = (config: OpenAPIClientConfig, request: {
  query: {
 ...
 */
export const trackersGet = (config: OpenAPIClientConfig, request: {
  path: {
 ...
 */
export const trackersPut = (config: OpenAPIClientConfig, request: {
  path: {
    /** The ID of the tracker in the <code><var>transaction_id</var>-<var>tracking_number</var></code> format. */
    id: string;
  };
...
export function createClient(config: OpenAPIClientConfig) {
  return createCustomClient(config, { trackersBatchPost, trackersBatchGet, trackersPost, trackersGet, trackersPut });
}

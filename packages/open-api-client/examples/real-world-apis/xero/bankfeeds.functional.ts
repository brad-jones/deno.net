 ...
 */
export const getFeedConnections = (config: OpenAPIClientConfig, request: {
  query?: {
 ...
 */
export const createFeedConnections = (config: OpenAPIClientConfig, request: {
  headers: {
    /** Xero identifier for Tenant */
    "Xero-Tenant-Id": string;
 ...
 */
export const getFeedConnection = (config: OpenAPIClientConfig, request: {
  path: {
 ...
 */
export const deleteFeedConnections = (config: OpenAPIClientConfig, request: {
  headers: {
    /** Xero identifier for Tenant */
    "Xero-Tenant-Id": string;
    /** This allows you to safely retry requests without the risk of duplicate processing. 128 character max. */
 ...
 */
export const getStatements = (config: OpenAPIClientConfig, request: {
  query?: {
 ...
 */
export const createStatements = (config: OpenAPIClientConfig, request: {
  headers: {
    /** Xero identifier for Tenant */
    "Xero-Tenant-Id": string;
    /** This allows you to safely retry requests without the risk of duplicate processing. 128 character max. */
 ...
 */
export const getStatement = (config: OpenAPIClientConfig, request: {
  path: {
